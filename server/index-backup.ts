...
// Initialize DB with realistic data
async function initData() {
  if ((await db.get(EMPLOYEES_KEY)) === null) {
    ...
    try {
      ...
      console.log('✓ Initialized database with realistic mock data');
    } catch (error) {
      console.log('⚠ Mock data files not found, using fallback sample data');
