...
export default function FieldFriendlyRAGPanel() {
  ...
  const { loading, summary, byProject, trend, reload } = (window as any).useManagerOverview
    ? (window as any).useManagerOverview(days)
    : require("../hooks/useManagerOverview").useManagerOverview(days);
